	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Vytváří dvouatomové, paramagnetické molekuly \ce{O2}.
		...
		\begin{column}{0.5\textwidth}
			\begin{figure}
				\adjincludegraphics[width=\textwidth]{img/Liquid_oxygen.jpg}
			\end{figure}
		\end{column}
	\end{columns}
}
...
\frame{
	\frametitle{}
	\begin{figure}
		\adjincludegraphics[width=.8\textwidth]{img/Diagramme_OM_O2.jpg}
	\end{figure}
}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Krystalová struktura \ce{Li2O}, šedé atomy jsou kyslíky.}
	\end{figure}
}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Vytváří cyklické osmiatomové molekuly, \ce{S8}. Známe několik dalších allotropických modifikací.
				...
				\item Hlavními zdroji síry jsou ropa a zemní plyn. \ce{SO2} pro výrobu kyseliny sírové se získává při redukci sulfidových rud.\footnote[frame]{\href{https://www.usgs.gov/centers/nmic/sulfur-statistics-and-information}{Sulfur Statistics and Information}}
			\end{itemize}
			\vfill
		\end{column}
		\begin{column}{0.5\textwidth}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Síra se těží i povrchově, těžař s 90 kg nákladem síry z vulkánu \href{https://commons.wikimedia.org/wiki/File:Kawah-Ijen_Indonesia_Ijen-Sulfur-Miner-04.jpg}{\textit{Ijen v Indonésii}}.\footnote[frame]{\href{https://commons.wikimedia.org/wiki/File:Kawah-Ijen_Indonesia_Ijen-Sulfur-Miner-04.jpg}{Zdroj: CEphoto, Uwe Aranas}}}
	\end{figure}
}
...
\frame{
	\frametitle{}
	\begin{itemize}
		\item Síra se využívá k \textit{vulkanizaci kaučuku}, tzn. k zesíťování řetězců přírodního kaučuku za vzniku \textit{pryže}.
...
\frame{
	...
	\begin{itemize}
		...
		\item \ce{SO2} se dříve získával spalováním elementární síry, dnes se častěji využívá oxid siřičitý z redukce sulfidických rud a jiných chemických procesů:
...
\frame{
	...
	\begin{itemize}
		...
		\begin{figure}
			\adjincludegraphics[height=.45\textheight]{img/Sulfur-trioxide-trimer.png}
		\end{figure}
	\end{itemize}
}
...
\frame{
	\frametitle{}
	\begin{figure}
		\adjincludegraphics[height=.7\textheight]{img/Schefeltrioxid.jpg}
		\caption*{Trimer oxidu sírového}
	\end{figure}
}
...
\frame{
	...
	\vfill
		\textbf{Livermorium}
		\begin{itemize}
			\item Umělý prvek, protonové číslo 116, Lv.
			...
			\item Nejstabilnějším izotopem je \ce{^{293}Lv} s poločasem rozpadu 57~ms.
			\item \ce{^{293}Lv ->[$T_{\frac{1}{2}}$ = 57 ms] ^{289}Fl + $\alpha$}
			\item Prvek byl v roce 2011 pojmenován Flerovium na počest sídla Lawrence Livermore National Laboratory.\footnote[frame]{\href{https://old.iupac.org/publications/ci/2012/3404/iw1_periodic_table.html}{Flerovium and Livermorium Join the Periodic Table}}
		\end{itemize}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{center}
		\adjincludegraphics[height=0.4\textheight]{img/Pierre_Curie_et_Marie_Sklodowska_Curie_1895.jpg}
		\adjincludegraphics[height=0.4\textheight]{img/Uraninite-usa32abg.jpg}
	\end{center}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Zemřela 4. července 1934 ve Francii na chorobu vyvolanou účinky radioaktivity.
	\end{itemize}
	\begin{center}
		\adjincludegraphics[height=0.35\textheight]{img/Pierre_Curie_Marie_Sklodowska_Curie.jpg}
		\adjincludegraphics[height=0.35\textheight]{img/Nobel_Prize.png}
	\end{center}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Kyslík a síra jsou izolanty, selen a tellur jsou polovodiče, polonium je kov.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Selen i tellur existují v několika allotropních modifikacích.
		\item \textit{Červený selen} krystaluje ve třech rozdílných modifikacích, tvořených cyklickými molekulami \ce{Se8}, které jsou analogické cyklooktasíře.
		\begin{itemize}
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Černý, šedý a červený selen}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.5\textheight]{img/Tellurium-acrylic.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item $\alpha$-Po je jediný prvek, který krystaluje v primitivní kubické mřížce.
	...
	\begin{columns}
		\begin{column}{.6\textwidth}
			\begin{figure}
				\adjincludegraphics[height=0.45\textheight]{img/Alpha_po_lattice.jpg}
			\end{figure}
		\end{column}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.35\textheight]{img/Selenium_in_sandstone.jpg}
		\caption*{Selen na pískovci}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Celosvětové zásoby jsou 80 000--90 000 tun.
		...
		\item Výluh se neutralizuje kyselinou sírovou, tellur se vysráží jako oxid a v roztoku zůstává seleničitan, který je následně redukován oxidem siřičitým:
...
\frame{
	...
	\begin{itemize}
		...
		\item Čistý selen je pak vyredukován vysoce čistým oxidem siřičitým:
		\item \ce{H2SeO3 + 2 SO2 + H2O -> Se + 2 H2SO4}
		\item Vysoce čistý selen se připravuje také zahříváním surového materiálu v atmosféře vodíku na teplotu 650~$^\circ$C za vzniku selanu.
		\item \ce{Se + H2 ->[650 $^\circ$C] SeH2}
		\item Ten se následně rozkládá v křemenné trubici při teplotě 1000~$^\circ$C.
		\item \ce{SeH2 ->[1000 $^\circ$C] Se + H2}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.4\textheight]{img/Gold-Sylvanite-282521.jpg}
		\adjincludegraphics[height=0.4\textheight]{img/Sylvanite.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[height=0.3\textheight]{img/Tellurium_crystal.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
	\adjincludegraphics[height=0.4\textheight]{img/Pechblende_Pribram.jpg}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{columns}
		...
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.8\textheight]{img/Xerographic_photocopy_process_cs.png}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
	...
	\begin{columns}
		...
		\begin{column}{.4\textwidth}
			\begin{figure}
				...
				\adjincludegraphics[width=\textwidth]{img/Selenium_Rectifier.jpg}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=.7\textheight]{img/Sphalerite-unit-cell-depth-fade-3D-balls.png}
		\caption*{Krystalová struktura CdTe}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Chakogenidy jsou sloučeniny chalkogenidů s elektropozitivnějšími prvky.
		\item Jedná se o velice běžné minerály.
		\item Formálně se jedná o soli bezkyslíkatých kyselin: \ce{H2Se}, \ce{H2Te} a \ce{H2Po}.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Selan, \ce{SeH2}, je bezbarvý, toxický, páchnoucí plyn.
		...
		\item \ce{2 SeH2 + 3 O2 -> 2 SeO2 + 2 H2O}
	\end{itemize}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Tellan, \ce{TeH2}, je bezbarvý, toxický, páchnoucí plyn.
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=0.7\textwidth]{img/Selenium-dioxide-chain-3D-balls.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Oxid seleničitý se využívá jako oxidační činidlo v organické syntéze.
		\item Dalším způsobem využití je barvení skla do červena, nebo k potlačování barvy skla způsobené železitými nečistotami.
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=0.7\textwidth]{img/Seleniumdioxide_oxidation.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\end{itemize}
	\begin{figure}
		\adjincludegraphics[width=0.3\textwidth]{img/Selenous-acid-from-xtal-1971-3D-balls.png}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[height=0.7\textheight]{img/Cryst_struct_teo2.png}
		\caption*{Krystalová struktura \ce{TeO2}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\begin{itemize}
		...
		\item Monokrystalová XRD analýza ukázala, že v krystalu je každý atom telluru obklopen dalšími dvěma tellury a dvěma jodidy. Tellury mají čtvercově planární geometrii, nevazebné elektronové páry jsou v kolmé rovině.
...
\frame{
	...
	\begin{itemize}
		...
		\item Další možností je fluorace oxidu seleničitého pomocí \ce{SeF4}:\footnote[frame]{\href{https://doi.org/10.1002/9780470132555.ch9}{Selenium Tetrafluoride, Selenium Difluoride Oxide (Seleninyl Fluoride), and Xenon Bis[Pentafluorooxoselenate(VI)]}}
