...
\frame{
	...
	\begin{itemize}
		...
		\item Hlavními zdroji síry jsou ropa a zemní plyn.\footnote[frame]{\href{https://www.usgs.gov/centers/nmic/sulfur-statistics-and-information}{Sulfur Statistics and Information}}
		\item \ce{SO2} pro výrobu kyseliny sírové se získává při redukci sulfidových rud.
	\end{itemize}
}
